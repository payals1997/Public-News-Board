...
const Register = () => {
  ...
  const validationSchema = Yup.object().shape({
    ...
    role: Yup.string()
      .oneOf(["reporter", "reader"], "Required")
      .required("Required"),
    phone: Yup.number()
          ...
          {(props) => (
            <Form>
              <Field
                ...
                helperText={<ErrorMessage name="name" component="errorMsg" />}
              />
              <Field
                as={TextField}
                fullWidth
                ...
                helperText={<ErrorMessage name="email" component="errorMsg" />}
              />
              <Field
                as={TextField}
                fullWidth
                ...
                helperText={<ErrorMessage name="city" component="errorMsg" />}
              />
              <Field
                as={TextField}
                fullWidth
              ...
              />
              <FormHelperText>
                <ErrorMessage name="termsAndConditions" component="errorMsg" />
              </FormHelperText>
