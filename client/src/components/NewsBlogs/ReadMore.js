...
const ReadMore = () => {
  ...
  useEffect(() => {
    ...
    axios
      .post(`http://localhost:3001/newsBlogs/byId/${id}`)
      .then((response) => {
        setReadmoreData(response.data);
      });
  }, []);
        ...
        <div className="newsCard">
          ...
          <div className="newsText">
            ...
            <div className="newsContent">
              ...
              {ReadmoreData.video === !null ? (
                <div>
                  <video src={ReadmoreData.video} controls></video>
                </div>
              ) : null}

              <span className="author">
                <b>Reported by {ReadmoreData.Reporter_name}</b>
              </span>
            </div>
